...
#         ret = helpers.CLIContext("", 1234, False, False)
#
#         assert mock_url.return_value == ret._api_url
#
...
#
#         assert helpers.print_message(response) is True
...
#         click_echo.echo = Mock(return_value=1)
#
#         assert helpers.print_message(response, debug=True) is True
...
#         click_echo.echo = Mock(return_value=1)
#
#         assert helpers.print_message(response) is False
...
#         click_echo.echo = Mock(return_value=1)
#
#         helpers.print_items(response, ['id', 'name'])
...
#         click_echo.secho = Mock(return_value=1)
#
#         helpers.print_items(response, ['ignore'])
...
#         click_echo.echo = Mock(return_value=1)
#
#         helpers.print_items(response, ['id', 'name'], debug=True)
#         click_echo.echo.assert_called_with(self.response_text)
#
...
#         click_echo.echo = Mock(return_value=1)
#
#         helpers.print_items(response, ['id', 'name', 'pause_time'], localize=True)
...
#
#         helpers.print_items(response, ['id', 'name'], True)
...
#         click_echo.secho = Mock(return_value=1)
#
#         helpers.save_yaml(response, '/tmp', 'test')
...
#         click_echo.echo = Mock(return_value=1)
#
#         helpers.save_yaml(response, '', '', True)
...
#         click_echo.echo_via_pager = Mock(return_value=1)
#
#         helpers.save_yaml(response, '', '', True, True, True)
...
#         click_echo.echo = Mock(return_value=1)
#
#         helpers.save_yaml(response, '', '', True, debug=True)
