...
#
#
# @patch("cryton.worker.util.logger.logger", logger.structlog.getLogger("cryton-worker-debug"))
...
#
#     @patch("cryton.worker.consumer.Consumer._update_connection", Mock())
#     @patch("cryton.worker.consumer.Consumer._start_channel_consumers", Mock())
...
#
#     @patch("cryton.worker.consumer.Consumer._update_connection")
#     @patch("cryton.worker.consumer.Consumer._start_channel_consumers", Mock())
#     @patch("cryton.worker.worker.time.sleep")
...
#
#     @patch("cryton.worker.consumer.Consumer._create_connection")
...
#
#     @patch("cryton.worker.consumer.Consumer._create_connection", Mock())
...
#     @patch("cryton.worker.consumer.ChannelConsumer")
...
#
#     @patch("cryton.worker.task.AttackTask")
