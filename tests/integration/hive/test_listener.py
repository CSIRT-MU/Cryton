...
# @patch('cryton.hive.services.listener.Process', Mock())
# @patch('cryton.hive.services.listener.Event', Mock())
...
#
#     @patch('cryton.hive.utility.rabbit_client.RpcClient.__enter__')
