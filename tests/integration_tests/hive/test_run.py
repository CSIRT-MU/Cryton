...
@patch("cryton_core.lib.models.plan.os.makedirs", Mock())
class TestRun(TestCase):
    ...
    @patch('cryton_core.lib.util.scheduler_client.remove_job')
...
class TestVariables(TestCase):
    ...
    @patch('cryton_core.lib.util.scheduler_client.schedule_function')
    @patch('cryton_core.lib.util.scheduler_client.remove_job')
    @patch('cryton_core.lib.models.step.StepExecutionWorkerExecute.execute')
