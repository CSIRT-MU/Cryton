...
class TestWorker(TestCase):
    ...
    @patch("cryton_worker.lib.worker.Worker._remove_trigger", Mock())
    ...
    @patch("cryton_worker.lib.triggers.HTTPListener.add_trigger")
    ...
    @patch("cryton_worker.lib.worker.Listener", Mock())
