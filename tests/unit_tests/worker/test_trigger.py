...
from cryton_worker.lib.triggers import HTTPListener, Listener, ListenerEnum, exceptions, MSFListener
from cryton_worker.lib.triggers.listener_http import MyWSGIRefServer
from cryton_worker.lib.util import constants as co


class TestMyWSGIRefServer(TestCase):

    @patch("cryton_worker.lib.triggers.listener_http.make_server")
...
class TestHTTPListener(TestCase):
    ...
    @patch("cryton_worker.lib.triggers.listener_http.HTTPListener._restart")
    ...
    @patch("cryton_worker.lib.triggers.listener_http.HTTPListener.stop")
    def test__restart_only_stop(self, mock_stop):
        self.listener_obj._stopped = False
        self.listener_obj._restart()
        mock_stop.assert_called()

    @patch("cryton_worker.lib.triggers.listener_http.HTTPListener.start")
    @patch("cryton_worker.lib.triggers.listener_http.HTTPListener.stop")
    ...
    @patch("cryton_worker.lib.triggers.listener_http.HTTPListener._check_parameters")
    @patch("cryton_worker.lib.triggers.listener_http.HTTPListener._notify")
    ...
    @patch("cryton_worker.lib.triggers.listener_http.MyWSGIRefServer")
...
class TestMSFListener(TestCase):
    ...
    @patch("cryton_worker.lib.triggers.listener_msf.MSFListener.start")
    @patch("cryton_worker.lib.triggers.listener_base.Listener._generate_id")
    ...
    @patch("cryton_worker.lib.triggers.listener_msf.MSFListener.any_trigger_exists")
    def test_add_trigger_error(self, mock_exists):
        mock_exists.return_value = True
        with self.assertRaises(exceptions.TooManyTriggers):
            self.listener_obj.add_trigger(self.details)

    @patch("cryton_worker.lib.triggers.listener_msf.MSFListener.stop")
    ...
    @patch("cryton_worker.lib.triggers.listener_msf.MSFListener._notify")
