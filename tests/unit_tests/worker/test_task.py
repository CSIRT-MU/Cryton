...
from cryton_worker.lib.util import constants as co, logger
...
class TestTask(TestCase):
    ...
    # @patch("cryton_worker.lib.task.get_context.Process", Mock())
    def setUp(self):
    ...
    @patch("cryton_worker.lib.task.Task.send_ack", Mock())
    ...
    @patch("cryton_worker.lib.task.Task.__call__", Mock())
    def test_start(self):
...
class TestAttackTask(TestCase):
    ...
    @patch("cryton_worker.lib.task.Task._run_in_process")
