...
from cryton.hive.models import stage, step
from cryton.hive.utility import creator, exceptions


@pytest.mark.django_db
class TestCreator:
    def test_create_plan(self, mocker):
        mock_plan = mocker.patch("cryton.hive.utility.creator.plan.Plan")
        mock_stage = mocker.patch("cryton.hive.utility.creator.stage.Stage")
        mocker.patch("cryton.hive.utility.creator.stage.StageModel")
        mock_create_stage = mocker.patch("cryton.hive.utility.creator.create_stage")
    ...
    def test_create_plan_dependency_error(self, mocker):
        mocker.patch("cryton.hive.utility.creator.create_stage")
        mocker.patch("cryton.hive.utility.creator.stage.Stage")
        mock_plan = mocker.patch("cryton.hive.utility.creator.plan.Plan")
        mock_stage_model_get = mocker.patch("cryton.hive.utility.creator.stage.StageModel.objects.get")
    ...
    def test_create_stage(self, mocker):
        mock_stage = mocker.patch("cryton.hive.utility.creator.stage.Stage")
        mock_create_step = mocker.patch("cryton.hive.utility.creator.create_step")
        mocker.patch("cryton.hive.utility.creator.step.Step")
        mock_create_successor = mocker.patch("cryton.hive.utility.creator.create_successor")
    ...
    def test_create_step(self, mocker, test_step_dict):
        mock_step = mocker.patch("cryton.hive.utility.creator.step.Step")
        mock_create_mapping = mocker.patch("cryton.hive.utility.creator.create_output_mapping")
    ...
    def test_create_successor(self, mocker, test_values):
        mocker.patch("cryton.hive.utility.creator.step.StepModel.objects.get")
    ...
    def test_create_successor_non_existent(self, mocker):
        mock_step_model_get = mocker.patch("cryton.hive.utility.creator.step.StepModel.objects.get")
    ...
    def test_create_output_mapping(self, mocker):
        mock_mapping_create = mocker.patch("cryton.hive.utility.creator.OutputMappingModel.objects.create")
    ...
    def test_create_worker(self, mocker, w_name, w_description):
        mock_worker = mocker.patch("cryton.hive.utility.creator.worker.Worker")
