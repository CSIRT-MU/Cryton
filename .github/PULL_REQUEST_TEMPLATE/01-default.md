...
1. Check out the PR branch and install the application using uv (make sure the prerequisites are running)
    ```
    git checkout my-branch
    uv sync --all-extras --all-groups
    cryton-core start
    ```
2. Clone CLI, check out to the related PR branch and install the application using uv
    ```
