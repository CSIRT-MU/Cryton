...
@click.option("-Rh", "--rabbit-host", type=click.STRING, default=SETTINGS.rabbit.host, show_default=True,
              help="Rabbit server host.")
@click.option("-RP", "--rabbit-port", type=click.INT, default=SETTINGS.rabbit.port, show_default=True,
              help="Rabbit server port.")
@click.option("-n", "--name", type=click.STRING, default=SETTINGS.name, show_default=True,
              help="What name should the Worker use (will be used to match your Worker).")
@click.option("-cc", "--consumer-count", type=click.INT, default=SETTINGS.consumer_count, show_default=True,
