...
class ValidationError(Error):
    ...
    def __init__(self, message: dict | Exception | str):
...
class PlanValidationError(ValidationError):
    ...
    def __init__(self, message: Exception | str, plan_name: str = None):
...
class StepValidationError(ValidationError):
    ...
    def __init__(self, message: Exception | str, step_name: str = None):
...
class UserInputError(Error):
    ...
    def __init__(self, message: Exception | str, user_input: str | int = None):
...
class PlanExecutionDoesNotExist(ObjectDoesNotExist):
    ...
    def __init__(self, message: Exception | str = "PlanExecution not found", plan_execution_id: str = None):
...
class StageObjectDoesNotExist(ObjectDoesNotExist):
    ...
    def __init__(self, message: Exception | str, stage_id: int = None, plan_id: int = None):
...
class StepExecutionObjectDoesNotExist(ObjectDoesNotExist):
    ...
    def __init__(self, message: Exception | str = "StepExecution not found", step_execution_id: str = None):
...
class SuccessorObjectDoesNotExist(ObjectDoesNotExist):
    ...
    def __init__(self, message: Exception | str, step_id: int = None):
...
class SessionObjectDoesNotExist(ObjectDoesNotExist):
    ...
    def __init__(
        ...
        session_id: int = None,
        plan_execution_id: Type[int] | int = None,
        step_id: int = None,
        plan_id: int = None,
        target=None,
        target_id=None,
...
class SessionIsNotOpen(Error):
    ...
    def __init__(self, message: Exception | str, session_name: str, plan_execution_id: Type[int] | int, step_id: int):
        self.message = {
            "message": message,
            "session_name": session_name,
            "plan_execution_id": plan_execution_id,
...
class InvalidStateError(Error):
    ...
    def __init__(self, message: Exception | str):
...
class UnexpectedValue(Error):
    ...
    def __init__(self, message: Exception | str, wrong_value: str | int = None):
...
class WrongParameterError(Error):
    ...
    def __init__(self, message: Exception | str = "Wrong parameter name", param_name: str = None):
...
class ParameterMissingError(Error):
    ...
    def __init__(self, message: Exception | str = "Missing parameter", param_name: str = None):
        self.message = {"message": message, "param_name": param_name}
        super().__init__(self.message)
...
class InvalidSuccessorType(Error):
    ...
    def __init__(self, message: Exception | str = "Wrong successor type", successor_type: str = None):
...
class InvalidSuccessorValue(Error):
    ...
    def __init__(self, message: Exception | str = "Wrong successor value", successor_value: str = None):
