...
def plan_list(ctx: helpers.Context, less: bool, offset: int, limit: int, localize: bool,
...
def plan_execution_list(ctx: helpers.Context, less: bool, offset: int, limit: int, localize: bool,
