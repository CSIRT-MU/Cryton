    ...
    async def generate_payload(self, stager_arguments: dict, listener_arguments: dict) -> str:
        ...
        if "error" in listener_get_response:
            ...
            try:
                ...
                raise KeyError("Listener could not be created. Check if port is not already in use.")
        ...
        try:
            ...
            logger.logger.error("Stager could not be generated, check if the supplied listener exists.")
            raise KeyError("Stager could not be generated, check if the supplied listener exists.")
