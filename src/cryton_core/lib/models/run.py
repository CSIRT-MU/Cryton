...
from cryton_core.cryton_app.models import RunModel, PlanExecutionModel, WorkerModel
from cryton_core.lib.util import exceptions, logger, scheduler_client, states as st
from cryton_core.lib.models.plan import PlanExecution
...
class Run:
    ...
    def schedule(self, schedule_time: datetime) -> None:
        ...
        # Schedule execution
        self.aps_job_id = scheduler_client.schedule_function("cryton_core.lib.models.run:execution",
